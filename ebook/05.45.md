...
overtls 搭配 tun2proxy 可以实现全局翻墙，并且使用简单，缺点是不能国内外分流，也不能对流量进行比较精确的控制。overtls 搭配 [sing-box](https://github.com/SagerNet/sing-box) 就基本没有缺点了
...
- [overtls + sing-box，分享一个比较完美的 sing-box 配置](05.46.md)
- [sing-box 基础教程：sing-box 的配置方法和使用教程](https://icloudnative.io/posts/sing-box-tutorial/)
