...
**[/usr/bin/shdowsocks-firewall](https://github.com/softwaredownload/openwrt-fanqiang/blob/master/openwrt/default/usr/bin/ss-firewall-asia):**
...
- iptables -t nat -N SHADOWSOCKS_WHITELIST 相关行
    ...
    一般不建议使用 [ip_china.txt](https://github.com/softwaredownload/openwrt-fanqiang/blob/master/openwrt/default/etc/ip_china.txt)
