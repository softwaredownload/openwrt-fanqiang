...
[本项目](https://github.com/softwaredownload/openwrt-fanqiang) [/openwrt-fanqiang/openwrt/default/usr/bin](https://github.com/softwaredownload/openwrt-fanqiang/tree/master/openwrt/default/usr/bin) 下有三个文件，用来切换不同的翻墙模式，分别是：
...
2018-10 起，本项目 /openwrt/default/usr/bin/ 下新增几个文件用来切换路由器的翻墙模式：
